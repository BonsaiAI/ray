...
class _MoabBaseWrapper(gym.Env):
    ...
    def __init__(self, seed: Optional[int] = None):
        ...
        state_fields_count = len(self._get_state_field_list())
    ...
    @classmethod
    def _get_state_field_list(cls) -> List[str]:
    ...
    def _filter_state(cls, state: Dict[str, float]) -> List[float]:
        ...
        filtered_state = []
        for k in cls._get_state_field_list():
...
class MoabMoveToCenterAvoidObstacleWrapper(MoabMoveToCenterWrapper):
    ...
    @classmethod
    def _get_state_field_list(cls) -> List[str]:
        fields = MoabMoveToCenterWrapper._get_state_field_list()
        # Obstacle data
