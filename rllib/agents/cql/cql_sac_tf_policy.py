...
from ray.rllib.agents.sac.sac_tf_policy import ActorCriticOptimizerMixin, \
    ...
    gradients, apply_gradients, SACTFPolicy, sac_actor_critic_loss
...
def cql_compute_and_clip_gradients(policy: Policy, optimizer: LocalOptimizer,
    ...
    grads_and_vars = gradients(policy, optimizer, loss)
...
CQLSACTFPolicy = SACTFPolicy.with_updates(
    name="CQLSACTFPolicy",
    get_default_config=lambda: ray.rllib.agents.cql.CQL_DEFAULT_CONFIG,
