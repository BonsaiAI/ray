...
from sac.rllib_proxy._added import ray_get_and_free
from sac.rllib_proxy._patched._replay_buffer import (
...
class SyncReplayOptimizer(PolicyOptimizer):
    ...
    def __init__(self,
        ...
        Arguments:
            ...
            remote_evaluators: all remote evaluators.
    ...
    def step(self):
        ...
        with self.sample_timer:
            if self.remote_evaluators:
                ...
                batch = self.local_evaluator.local_worker().sample()
        ...
        with self.grad_timer:
            if self.before_learn_on_batch:
                samples = self.before_learn_on_batch(
                    samples,
                    self.local_evaluator.policy_map,
